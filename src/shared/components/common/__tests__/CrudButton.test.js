...
import CrudButton, { AddButton, CancelButton, DeleteButton, EditButton } from '../CrudButton';
...
describe('CrudButton wrappers', () => {
  ...
  test('CancelButton uses default Cancel label', () => {
    const { getByRole, getByText } = render(<CancelButton />);
