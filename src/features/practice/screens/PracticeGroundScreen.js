...
import HelpButton from '../../../shared/components/header/HelpButton';
import ProfileButton from '../../../shared/components/header/ProfileButton';
import SearchBar from '../../../shared/components/common/SearchBar';
import { colors, spacing } from '../../../shared/theme';
import { homeContent } from '../data/practiceGroundText';

export default function PracticeGroundScreen() {
  return (
